...
## How does it work?
Run this app in the background.  After each combat cycle arcdps generates a log file.  This program collects the data and sends the data to your provided Discord (optionally Twitch).  [Example](#example)
## Table of Contents
- [Overview](#overview)
