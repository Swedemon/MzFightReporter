...
- **Long Fights**: Fights exceeding 15 minutes run the risk of not reporting due to system memory restraints.  Healing data will not be included when the arcdps logs exceed 10MB.
